...
#include "dberror.h"
#include "stdlib.h"
FILE *SetFile_Pointer,*SetFile_Pointer_End;
...
//fseek(SetFile_Pointer_End,0,SEEK_END);   
 return RC_OK;
}
...
RC openPageFile (char *fileName, SM_FileHandle *fHandle)
{
    ...
    {
SetFile_Pointer_End=SetFile_Pointer;
        fHandle->mgmtInfo = SetFile_Pointer;
     //  fseek(SetFile_Pointer, 0, SEEK_END);
        file_size = ftell(SetFile_Pointer_End);
